import { UniverseEdition } from '../types';

export const UNIVERSE_EDITIONS: UniverseEdition[] = [
  {
    id: 'emily-in-paris',
    title: 'Emily in Paris Edit',
  ...
  },
  {
    ...
    title: 'The Summer I Turned Pretty Edit',
  ...
  {
    id: 'to-all-the-boys',
    title: "To All the Boys I've Loved Before Edit",
    tagline: 'Soft academia, pastel scrunchies & love-letter charms',
    aesthetic: 'Powder blue, dusty blush & romantic hearts',
    accentColor: '#A63A32',
  ...
  {
    id: 'bridgerton',
    title: 'Bridgerton Edit',
    tagline: 'Regency opulence, sparkling sapphires & diamond of the season',
    aesthetic: 'Deep emerald, royal blue & regal swan motifs',
    accentColor: '#3E5C76',
